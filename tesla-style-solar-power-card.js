...
/**
     ...
     * http://polymer.github.io/PATENTS.txt
     */
class{handleAttributeExpressions(t,e,i,n){const s=e[0];if("."===s){return new N(t,e.slice(1),i).parts}if("@"===s)return[new k(t,e.slice(1),n.eventContext)];if("?"===s)return[new E(t,e.slice(1),i)];return new A(t,e,i).parts}handleTextExpression(t){return new P(t)}};
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
